...
import {
  ...
  sessions,
  verificationTokens,
} from "@/server/db/schema/next-auth-schema"
import { drizzleClient } from "@/server/db/client"

function LibsqlDrizzleAdapter(client: typeof drizzleClient) {
  return {
...
export const adapter = LibsqlDrizzleAdapter(drizzleClient)
